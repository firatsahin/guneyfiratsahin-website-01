...
<ul class="<?= $ulClass ?>">
    ...
    <li><i class="glyphicon glyphicon-thumbs-up"></i>&nbsp; Likes: <span name="like-count"><?= $post->likedCount ?></span></li>
    <li><i class="glyphicon glyphicon-comment"></i>&nbsp; Comments: <?= $post->commentsCount ?></li>
